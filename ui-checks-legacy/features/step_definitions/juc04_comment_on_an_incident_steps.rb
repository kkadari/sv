Given /^I have mentioned "([^\"]+)" in an anonymous comment$/ do |user|
  ...
  mention = '<p>This is a comment mentioning <a class=\'jive_macro jive_macro_user\' href=\'javascript:;\' jivemacro=\'user\' ___default_attr=\'' + user_profile[:user_id] + '\' data-objecttype=\'3\' data-orig-content=\'' + user_profile[:username] + '\'>' + user_profile[:username] + '</a></p>'
