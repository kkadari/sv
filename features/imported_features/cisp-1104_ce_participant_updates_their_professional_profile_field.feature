Feature: [CISP-1104] CE Participant updates their Professional Profile field
#<p>This test covers the following use case realisation - JUC1.1 - Participant establishes their Participant Profile, with focus on the newly added Professional Profile field.</p>
