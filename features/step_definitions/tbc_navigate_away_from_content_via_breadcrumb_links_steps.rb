...
Then /I am able to view more polls in a related container$/ do
  fail "Not on correct content page" unless @browser.url.include? "/groups/#{FigNewton.custom_group}/content?filterID=contentstatus[published]~objecttype~objecttype[poll]"
end
